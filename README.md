...
```
docker run --log-driver mickyg/kafka-logdriver:0.1 hello-world
```
...
```
docker plugin set mickyg/kafka-logdriver:0.1 KAFKA_BROKER_ADDR="192.168.0.1:9092"
```
...
Test it! Connect to your broker and consume from the "dockerlogs" topic
